...
/** Dedicated Android Share target for Google Maps location sharing. */
public class ShareReceiverActivity extends Activity {
    ...
    private void handleShareIntent(Intent intent) {
        ...
        // A few Android share providers place the URL in EXTRA_STREAM.
        Uri stream = intent.getParcelableExtra(Intent.EXTRA_STREAM);
        if (text.trim().isEmpty() && stream != null) text = stream.toString();
